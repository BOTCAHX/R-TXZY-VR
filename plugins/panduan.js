...
let handler = async(m, { conn, usedPrefix, args, command }) => {
    ...
    let tulisan = `
Halo ${name}, ${ucapan()} selamat datang di menu panduan Fachri Botz. di menu ini kalian bisa mendapatkan panduan soal bot whatsapp.
┌〔 List Panduan 〕
├ how
├ owner
├ add
